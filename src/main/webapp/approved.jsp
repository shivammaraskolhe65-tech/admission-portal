...
<head>
    ...
    <style>
        ...
        .btn { padding: 5px 10px; border: none; cursor: pointer; color: white; text-decoration: none; background-color: #dc3545; border-radius:3px; }
    </style>
</head>
<body>
...
<div class="main">
    <h2>Approved Student Applications</h2>
    <table>
        <tr>
            <th>SR.NO.</th>
            <th>Student ID</th>
        ...
        <tr>
            ...
            <td style="color:green; font-weight:bold;"><%= rs.getString("status") %></td>
            <td>
                <a class="btn" href="UpdateStatusServlet?id=<%= rs.getInt("application_id") %>&status=Rejected">Reject</a>
            </td>
        </tr>
        <%
                }
